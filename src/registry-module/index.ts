// https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/resources/registry_module
...
export class RegistryModule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistryModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/resources/registry_module#import import section} in the documentation of this resource for the id to use
