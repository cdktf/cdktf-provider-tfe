...
// https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack
...
export interface StackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#description Stack#description}
  */
  readonly description?: string;
  /**
  * Name of the Stack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#name Stack#name}
  */
  readonly name: string;
  /**
  * ID of the project that the Stack belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#project_id Stack#project_id}
  */
  readonly projectId: string;
  /**
  * vcs_repo block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#vcs_repo Stack#vcs_repo}
  */
...
export interface StackVcsRepo {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#branch Stack#branch}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#github_app_installation_id Stack#github_app_installation_id}
  */
  readonly githubAppInstallationId?: string;
  /**
  * Identifier of the VCS repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#identifier Stack#identifier}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#oauth_token_id Stack#oauth_token_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack tfe_stack}
*/
export class Stack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Stack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/stack tfe_stack} Resource
  *
  * @param scope The scope in which to define this construct
