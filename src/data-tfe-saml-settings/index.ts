// https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/data-sources/saml_settings
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/data-sources/saml_settings tfe_saml_settings}
*/
export class DataTfeSamlSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeSamlSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/data-sources/saml_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/data-sources/saml_settings tfe_saml_settings} Data Source
  *
  * @param scope The scope in which to define this construct
