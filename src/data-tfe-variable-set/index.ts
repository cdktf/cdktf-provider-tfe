...
// https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/data-sources/variable_set
...
export class DataTfeVariableSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeVariableSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/data-sources/variable_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/data-sources/variable_set tfe_variable_set} Data Source
  *
  * @param scope The scope in which to define this construct
