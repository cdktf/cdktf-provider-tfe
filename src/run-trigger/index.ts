...
// https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/run_trigger
...
export class RunTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RunTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/run_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/run_trigger tfe_run_trigger} Resource
  *
  * @param scope The scope in which to define this construct
