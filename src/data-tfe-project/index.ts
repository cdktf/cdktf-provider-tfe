// https://registry.terraform.io/providers/hashicorp/tfe/0.58.1/docs/data-sources/project
...
export class DataTfeProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.58.1/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.58.1/docs/data-sources/project tfe_project} Data Source
  *
  * @param scope The scope in which to define this construct
