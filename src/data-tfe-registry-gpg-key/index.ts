...
// https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/data-sources/registry_gpg_key
...
export class DataTfeRegistryGpgKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeRegistryGpgKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/data-sources/registry_gpg_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/data-sources/registry_gpg_key tfe_registry_gpg_key} Data Source
  *
  * @param scope The scope in which to define this construct
