...
// https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/ssh_key
...
export class SshKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/ssh_key tfe_ssh_key} Resource
  *
  * @param scope The scope in which to define this construct
