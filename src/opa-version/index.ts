...
// https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/opa_version
...
export interface OpaVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly archs?: OpaVersionArchs[] | cdktf.IResolvable;
  /**
...
export interface OpaVersionArchs {
  /**
...
export function opaVersionArchsToTerraform(struct?: OpaVersionArchs | cdktf.IResolvable): any {
...
export function opaVersionArchsToHclTerraform(struct?: OpaVersionArchs | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OpaVersionArchsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OpaVersionArchs | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OpaVersionArchs | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OpaVersionArchsList extends cdktf.ComplexList {
  public internalValue? : OpaVersionArchs[] | cdktf.IResolvable
  ...
  */
  public get(index: number): OpaVersionArchsOutputReference {
    return new OpaVersionArchsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class OpaVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpaVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/opa_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/opa_version tfe_opa_version} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _archs = new OpaVersionArchsList(this, "archs", true);
  public get archs() {
    return this._archs;
  }
  public putArchs(value: OpaVersionArchs[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      archs: cdktf.listMapper(opaVersionArchsToTerraform, false)(this._archs.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      archs: {
        value: cdktf.listMapperHcl(opaVersionArchsToHclTerraform, false)(this._archs.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "OpaVersionArchsList",
      },
      beta: {
