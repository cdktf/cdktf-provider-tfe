// https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/resources/opa_version
...
export class OpaVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpaVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/resources/opa_version#import import section} in the documentation of this resource for the id to use
