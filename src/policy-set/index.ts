...
// https://registry.terraform.io/providers/hashicorp/tfe/0.64.0/docs/resources/policy_set
...
export class PolicySet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.64.0/docs/resources/policy_set#import import section} in the documentation of this resource for the id to use
