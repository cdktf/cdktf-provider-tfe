// https://registry.terraform.io/providers/hashicorp/tfe/0.55.0/docs/resources/project_oauth_client
...
export class ProjectOauthClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectOauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.55.0/docs/resources/project_oauth_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.55.0/docs/resources/project_oauth_client tfe_project_oauth_client} Resource
  *
  * @param scope The scope in which to define this construct
