// https://registry.terraform.io/providers/hashicorp/tfe/0.53.0/docs/resources/oauth_client
...
export class OauthClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.53.0/docs/resources/oauth_client#import import section} in the documentation of this resource for the id to use
