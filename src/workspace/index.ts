...
// https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/resources/workspace
...
export interface WorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly hyokEnabled?: boolean | cdktf.IResolvable;
  /**
...
export class Workspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Workspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/resources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: WorkspaceConfig) {
    ...
    this._hyokEnabled = config.hyokEnabled;
    this._id = config.id;
  ...
  // hyok_enabled - computed: false, optional: true, required: false
  private _hyokEnabled?: boolean | cdktf.IResolvable; 
  public get hyokEnabled() {
    return this.getBooleanAttribute('hyok_enabled');
  }
  public set hyokEnabled(value: boolean | cdktf.IResolvable) {
    this._hyokEnabled = value;
  }
  public resetHyokEnabled() {
    this._hyokEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get hyokEnabledInput() {
    return this._hyokEnabled;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hyok_enabled: cdktf.booleanToTerraform(this._hyokEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hyok_enabled: {
        value: cdktf.booleanToHclTerraform(this._hyokEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
