...
// https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/workspace
...
export class Workspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Workspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/resources/workspace tfe_workspace} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WorkspaceConfig) {
    ...
    this._autoDestroyAt = config.autoDestroyAt;
    ...
    this._id = config.id;
    this._ignoreAdditionalTagNames = config.ignoreAdditionalTagNames;
  ...
  // auto_destroy_activity_duration - computed: true, optional: true, required: false
  ...
  // auto_destroy_at - computed: true, optional: true, required: false
  private _autoDestroyAt?: string; 
  public get autoDestroyAt() {
    return this.getStringAttribute('auto_destroy_at');
  }
  public set autoDestroyAt(value: string) {
    this._autoDestroyAt = value;
  }
  public resetAutoDestroyAt() {
    this._autoDestroyAt = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get autoDestroyAtInput() {
    return this._autoDestroyAt;
  }
  ...
  // ignore_additional_tag_names - computed: false, optional: true, required: false
  private _ignoreAdditionalTagNames?: boolean | cdktf.IResolvable; 
  public get ignoreAdditionalTagNames() {
    return this.getBooleanAttribute('ignore_additional_tag_names');
  }
  public set ignoreAdditionalTagNames(value: boolean | cdktf.IResolvable) {
    this._ignoreAdditionalTagNames = value;
  }
  public resetIgnoreAdditionalTagNames() {
    this._ignoreAdditionalTagNames = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ignoreAdditionalTagNamesInput() {
    return this._ignoreAdditionalTagNames;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      auto_destroy_at: cdktf.stringToTerraform(this._autoDestroyAt),
      ...
      ignore_additional_tag_names: cdktf.booleanToTerraform(this._ignoreAdditionalTagNames),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      auto_destroy_at: {
        value: cdktf.stringToHclTerraform(this._autoDestroyAt),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      ignore_additional_tag_names: {
        value: cdktf.booleanToHclTerraform(this._ignoreAdditionalTagNames),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
