...
// https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_module
...
export class DataTfeRegistryModuleVcsRepoOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // tag_prefix - computed: true, optional: false, required: false
...
export class DataTfeRegistryModule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeRegistryModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_module tfe_registry_module} Data Source
  *
  * @param scope The scope in which to define this construct
