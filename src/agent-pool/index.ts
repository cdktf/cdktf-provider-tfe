// https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_pool
...
export class AgentPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_pool tfe_agent_pool} Resource
  *
  * @param scope The scope in which to define this construct
