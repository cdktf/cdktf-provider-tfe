// https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_token
...
export class AgentToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.50.0/docs/resources/agent_token tfe_agent_token} Resource
  *
  * @param scope The scope in which to define this construct
