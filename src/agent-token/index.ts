...
// https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/resources/agent_token
...
export class AgentToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/resources/agent_token#import import section} in the documentation of this resource for the id to use
