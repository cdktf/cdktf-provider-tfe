// https://registry.terraform.io/providers/hashicorp/tfe/0.53.0/docs/data-sources/no_code_module
...
export class DataTfeNoCodeModule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeNoCodeModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.53.0/docs/data-sources/no_code_module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.53.0/docs/data-sources/no_code_module tfe_no_code_module} Data Source
  *
  * @param scope The scope in which to define this construct
