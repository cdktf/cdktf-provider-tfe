// https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/data-sources/no_code_module
...
export class DataTfeNoCodeModule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeNoCodeModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/data-sources/no_code_module#import import section} in the documentation of this resource for the id to use
