...
// https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/test_variable
...
export class TestVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TestVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/test_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/test_variable tfe_test_variable} Resource
  *
  * @param scope The scope in which to define this construct
