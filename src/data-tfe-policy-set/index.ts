// https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/policy_set
...
export class DataTfePolicySet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfePolicySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/policy_set#import import section} in the documentation of this resource for the id to use
