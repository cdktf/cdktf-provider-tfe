// https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/resources/no_code_module
...
export class NoCodeModule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NoCodeModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/resources/no_code_module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/resources/no_code_module tfe_no_code_module} Resource
  *
  * @param scope The scope in which to define this construct
