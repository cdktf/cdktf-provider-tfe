...
// https://registry.terraform.io/providers/hashicorp/tfe/0.64.0/docs/data-sources/slug
...
export class DataTfeSlug extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeSlug that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.64.0/docs/data-sources/slug#import import section} in the documentation of this resource for the id to use
