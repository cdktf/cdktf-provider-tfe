...
// https://registry.terraform.io/providers/hashicorp/tfe/0.57.1/docs/resources/sentinel_version
...
export class SentinelVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SentinelVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.1/docs/resources/sentinel_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.1/docs/resources/sentinel_version tfe_sentinel_version} Resource
  *
  * @param scope The scope in which to define this construct
