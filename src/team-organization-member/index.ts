...
// https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/resources/team_organization_member
...
export class TeamOrganizationMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamOrganizationMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/resources/team_organization_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.54.0/docs/resources/team_organization_member tfe_team_organization_member} Resource
  *
  * @param scope The scope in which to define this construct
