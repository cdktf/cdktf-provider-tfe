// https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/resources/team_organization_member
...
export class TeamOrganizationMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamOrganizationMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.2/docs/resources/team_organization_member#import import section} in the documentation of this resource for the id to use
