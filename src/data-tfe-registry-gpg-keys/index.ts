// https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/data-sources/registry_gpg_keys
...
export class DataTfeRegistryGpgKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeRegistryGpgKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/data-sources/registry_gpg_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/data-sources/registry_gpg_keys tfe_registry_gpg_keys} Data Source
  *
  * @param scope The scope in which to define this construct
