...
// https://registry.terraform.io/providers/hashicorp/tfe/0.67.1/docs/data-sources/workspace
...
export class DataTfeWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.67.1/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.67.1/docs/data-sources/workspace tfe_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
