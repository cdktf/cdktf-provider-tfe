// https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider
...
export interface RegistryProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider#name RegistryProvider#name}
  */
  readonly name: string;
  /**
  * The namespace of the provider. For private providers this is the same as the oraganization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider#namespace RegistryProvider#namespace}
  */
  readonly namespace?: string;
  /**
  * Name of the organization. If omitted, organization must be defined in the provider config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider#organization RegistryProvider#organization}
  */
  readonly organization?: string;
  /**
  * Whether this is a publicly maintained provider or private. Must be either `public` or `private`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider#registry_name RegistryProvider#registry_name}
  */
  readonly registryName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider tfe_registry_provider}
*/
export class RegistryProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistryProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/resources/registry_provider tfe_registry_provider} Resource
  *
  * @param scope The scope in which to define this construct
