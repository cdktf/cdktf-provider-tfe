// https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/data-sources/agent_pool
...
export class DataTfeAgentPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeAgentPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/data-sources/agent_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.66.0/docs/data-sources/agent_pool tfe_agent_pool} Data Source
  *
  * @param scope The scope in which to define this construct
