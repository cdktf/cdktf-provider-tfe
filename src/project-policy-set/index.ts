// https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/resources/project_policy_set
...
export class ProjectPolicySet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectPolicySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/resources/project_policy_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/resources/project_policy_set tfe_project_policy_set} Resource
  *
  * @param scope The scope in which to define this construct
