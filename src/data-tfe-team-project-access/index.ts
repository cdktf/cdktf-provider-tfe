...
// https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/data-sources/team_project_access
...
export class DataTfeTeamProjectAccess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeTeamProjectAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/data-sources/team_project_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.60.0/docs/data-sources/team_project_access tfe_team_project_access} Data Source
  *
  * @param scope The scope in which to define this construct
