// https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/team_project_access
...
export class DataTfeTeamProjectAccess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeTeamProjectAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/team_project_access#import import section} in the documentation of this resource for the id to use
