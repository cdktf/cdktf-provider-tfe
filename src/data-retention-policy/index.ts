...
// https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy
...
export interface DataRetentionPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#organization DataRetentionPolicy#organization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#workspace_id DataRetentionPolicy#workspace_id}
  */
  readonly workspaceId?: string;
  /**
  * delete_older_than block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#delete_older_than DataRetentionPolicy#delete_older_than}
  */
  readonly deleteOlderThan?: DataRetentionPolicyDeleteOlderThan;
  /**
  * dont_delete block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#dont_delete DataRetentionPolicy#dont_delete}
  */
...
export interface DataRetentionPolicyDeleteOlderThan {
  ...
  * Number of days
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#days DataRetentionPolicy#days}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy tfe_data_retention_policy}
*/
export class DataRetentionPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.2/docs/resources/data_retention_policy tfe_data_retention_policy} Resource
  *
  * @param scope The scope in which to define this construct
