...
// https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/data_retention_policy
...
export class DataRetentionPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/data_retention_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/resources/data_retention_policy tfe_data_retention_policy} Resource
  *
  * @param scope The scope in which to define this construct
