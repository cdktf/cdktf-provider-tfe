...
// https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_provider
...
export class DataTfeRegistryProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeRegistryProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/registry_provider tfe_registry_provider} Data Source
  *
  * @param scope The scope in which to define this construct
