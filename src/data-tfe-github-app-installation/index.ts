...
// https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/data-sources/github_app_installation
...
export class DataTfeGithubAppInstallation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeGithubAppInstallation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/data-sources/github_app_installation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.70.0/docs/data-sources/github_app_installation tfe_github_app_installation} Data Source
  *
  * @param scope The scope in which to define this construct
