...
// https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token
...
export interface AuditTrailTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token#expired_at AuditTrailToken#expired_at}
  */
  readonly expiredAt?: string;
  /**
  * When set to true will force the audit trail token to be recreated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token#force_regenerate AuditTrailToken#force_regenerate}
  */
  readonly forceRegenerate?: boolean | cdktf.IResolvable;
  /**
  * Name of the organization. If omitted, organization must be defined in the provider config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token#organization AuditTrailToken#organization}
  */
  readonly organization?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token tfe_audit_trail_token}
*/
export class AuditTrailToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditTrailToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.0/docs/resources/audit_trail_token tfe_audit_trail_token} Resource
  *
  * @param scope The scope in which to define this construct
