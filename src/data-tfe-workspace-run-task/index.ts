...
// https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/data-sources/workspace_run_task
...
export class DataTfeWorkspaceRunTask extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeWorkspaceRunTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.57.0/docs/data-sources/workspace_run_task#import import section} in the documentation of this resource for the id to use
