...
// https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/team
...
export class DataTfeTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfeTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.49.2/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
