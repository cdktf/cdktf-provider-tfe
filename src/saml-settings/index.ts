...
// https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings
...
export interface SamlSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#attr_groups SamlSettings#attr_groups}
  */
  readonly attrGroups?: string;
  /**
  * Specifies the role for site admin access. Overrides the "Site Admin Role" method
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#attr_site_admin SamlSettings#attr_site_admin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#attr_username SamlSettings#attr_username}
  */
  readonly attrUsername?: string;
  /**
  * Ensure that <samlp:AuthnRequest> messages are signed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#authn_requests_signed SamlSettings#authn_requests_signed}
  */
  readonly authnRequestsSigned?: boolean | cdktf.IResolvable;
  /**
  * The certificate used for request and assertion signing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#certificate SamlSettings#certificate}
  */
  readonly certificate?: string;
  /**
  * When sign-on fails and this is enabled, the SAMLResponse XML will be displayed on the login page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#debug SamlSettings#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * Identity Provider Certificate specifies the PEM encoded X.509 Certificate as provided by the IdP configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#idp_cert SamlSettings#idp_cert}
  */
  readonly idpCert: string;
  /**
  * The private key used for request and assertion signing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#private_key SamlSettings#private_key}
  */
  readonly privateKey?: string;
  /**
  * Signature Digest Method. Must be either `SHA1` or `SHA256`. Defaults to `SHA256`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#signature_digest_method SamlSettings#signature_digest_method}
  */
  readonly signatureDigestMethod?: string;
  /**
  * Signature Signing Method. Must be either `SHA1` or `SHA256`. Defaults to `SHA256`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#signature_signing_method SamlSettings#signature_signing_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#site_admin_role SamlSettings#site_admin_role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#slo_endpoint_url SamlSettings#slo_endpoint_url}
  */
  readonly sloEndpointUrl: string;
  /**
  * Specifies the Single Sign On session timeout in seconds. Defaults to 14 days
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#sso_api_token_session_timeout SamlSettings#sso_api_token_session_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#sso_endpoint_url SamlSettings#sso_endpoint_url}
  */
  readonly ssoEndpointUrl: string;
  /**
  * Set it to false if you would rather use Terraform Enterprise to manage team membership
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#team_management_enabled SamlSettings#team_management_enabled}
  */
  readonly teamManagementEnabled?: boolean | cdktf.IResolvable;
  /**
  * Ensure that <saml:Assertion> elements are signed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings#want_assertions_signed SamlSettings#want_assertions_signed}
  */
  readonly wantAssertionsSigned?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings tfe_saml_settings}
*/
export class SamlSettings extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings tfe_saml_settings} Resource
  *
