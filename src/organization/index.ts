...
// https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/resources/organization
...
export interface OrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly enforceHyok?: boolean | cdktf.IResolvable;
  /**
...
export class Organization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/resources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: OrganizationConfig) {
    ...
    this._enforceHyok = config.enforceHyok;
    this._id = config.id;
  ...
  // enforce_hyok - computed: false, optional: true, required: false
  private _enforceHyok?: boolean | cdktf.IResolvable; 
  public get enforceHyok() {
    return this.getBooleanAttribute('enforce_hyok');
  }
  public set enforceHyok(value: boolean | cdktf.IResolvable) {
    this._enforceHyok = value;
  }
  public resetEnforceHyok() {
    this._enforceHyok = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enforceHyokInput() {
    return this._enforceHyok;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enforce_hyok: cdktf.booleanToTerraform(this._enforceHyok),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      enforce_hyok: {
        value: cdktf.booleanToHclTerraform(this._enforceHyok),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
