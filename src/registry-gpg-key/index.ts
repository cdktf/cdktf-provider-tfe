...
// https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key
...
export interface RegistryGpgKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key#ascii_armor RegistryGpgKey#ascii_armor}
  */
  readonly asciiArmor: string;
  /**
  * Name of the organization. If omitted, organization must be defined in the provider config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key#organization RegistryGpgKey#organization}
  */
  readonly organization?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key tfe_registry_gpg_key}
*/
export class RegistryGpgKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistryGpgKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.59.0/docs/resources/registry_gpg_key tfe_registry_gpg_key} Resource
  *
  * @param scope The scope in which to define this construct
