...
// https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs
...
export interface TfeProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#hostname TfeProvider#hostname}
  */
  ...
  * the resource itself
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#organization TfeProvider#organization}
  */
  readonly organization?: string;
  /**
  * Whether or not to skip certificate verifications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#ssl_skip_verify TfeProvider#ssl_skip_verify}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#token TfeProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#alias TfeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs tfe}
*/
export class TfeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TfeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.68.1/docs tfe} Resource
  *
  * @param scope The scope in which to define this construct
