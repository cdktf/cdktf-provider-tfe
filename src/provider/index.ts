// https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs
...
export class TfeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TfeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs#import import section} in the documentation of this resource for the id to use
