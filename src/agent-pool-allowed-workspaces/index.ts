// https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/agent_pool_allowed_workspaces
...
export class AgentPoolAllowedWorkspaces extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentPoolAllowedWorkspaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.65.1/docs/resources/agent_pool_allowed_workspaces#import import section} in the documentation of this resource for the id to use
