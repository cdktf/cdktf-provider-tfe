...
```go
import "github.com/cdktf/cdktf-provider-tfe-go/tfe/v12/datatfeworkspaceruntask"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.69.0/docs/data-sources/workspace_run_task#import import section} in the documentation of this resource for the id to use
