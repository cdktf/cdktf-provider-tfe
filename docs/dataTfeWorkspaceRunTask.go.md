...
```go
import "github.com/cdktf/cdktf-provider-tfe-go/tfe/v8/datatfeworkspaceruntask"
...
| <code><a href="#@cdktf/provider-tfe.dataTfeWorkspaceRunTask.DataTfeWorkspaceRunTaskConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.47.0/docs/data-sources/workspace_run_task#id DataTfeWorkspaceRunTask#id}. |
