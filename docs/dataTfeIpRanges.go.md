...
```go
import "github.com/cdktf/cdktf-provider-tfe-go/tfe/v7/datatfeipranges"
...
| <code><a href="#@cdktf/provider-tfe.dataTfeIpRanges.DataTfeIpRangesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.45.0/docs/data-sources/ip_ranges#id DataTfeIpRanges#id}. |
