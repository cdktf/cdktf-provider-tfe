...
Refer to the Terraform Registory for docs: [`tfe_saml_settings`](https://registry.terraform.io/providers/hashicorp/tfe/0.48.0/docs/resources/saml_settings).
...
```go
import "github.com/cdktf/cdktf-provider-tfe-go/tfe/v9/samlsettings"
